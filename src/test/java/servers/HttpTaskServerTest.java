...
class HttpTaskServerTest {
    ...
    public void start() throws IOException {
        ...
        epic1 = new Epic("Epic1Name", "Epic1Description", TasksStatus.NEW);
        ...
        subTask2Epic1 = new Subtask("subTask2Epic1Name",
    ...
    public void addNewTaskTest() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = client.send(request, HttpResponse.BodyHandlers.ofString());
        assertEquals(200, response.statusCode());
        Epic epic2 = new Epic("Epic2Name", "Epic2Description", TasksStatus.NEW);
        ...
        response = client.send(request, HttpResponse.BodyHandlers.ofString());
        assertEquals(200, response.statusCode());
        Subtask subTask1Epic2 = new Subtask("subTask1Epic2Name",
    ...
    public void updateTaskTest() throws IOException, InterruptedException {
        task1.setStatus(TasksStatus.DONE);
        URI url = URI.create("http://localhost:8080/tasks/task/");
    ...
    public void updateEpicTest() throws IOException, InterruptedException {
        subTask1Epic1.setStatus(TasksStatus.DONE);
        subTask2Epic1.setStatus(TasksStatus.DONE);
        URI url = URI.create("http://localhost:8080/tasks/epic/");
        String json = gson.toJson(task1);
        HttpRequest.BodyPublisher body = HttpRequest.BodyPublishers.ofString(json);
        HttpRequest request = HttpRequest.newBuilder().uri(url).POST(body).build();
